...
1. Create or select the ACM certificate for `domain_name`, Route53 zone (when managed here), the GitHub OIDC provider, and two Secrets Manager secrets: one for the rotated OpsVerse token and one placeholder for the Coolify API token.
